<?php 
	...
	*/
	...
	require_once 'plugin/html2doc/phpword/PHPWord.php';
	require_once 'plugin/html2doc/simplehtmldom/simple_html_dom.php';
	require_once 'plugin/html2doc/htmltodocx_converter/h2d_htmlconverter.php';
	require_once 'plugin/html2doc/example_files/styles.inc';
	...
	header('Content-Disposition: attachment; filename='.$filehtml.'.docx');
